...
mapping["stn"] = {
    ...
    "output": root + "O3D_STN/derivatives/tracking_csddet_tck/sub-{}/dwi/sub-{}_dwi_var-csddet-run-{}_tract.tck",
...
mapping["hcp3t"] = {
    ...
    "output": root + "O3D_HCP3T/derivatives/tracking_csddet_tck/sub-{}/dwi/sub-{}_dwi_var-csddet-run-{}_tract.tck",
