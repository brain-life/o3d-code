...
mapping["stn"] = {
    ...
    "output": root + "O3D_STN/derivatives/tracking_csddet_trk/sub-{}/dwi/sub-{}_dwi_var-csddet-run-{}_tract.trk",
...
mapping["hcp3t"] = {
    ...
    "output": root + "O3D_HCP3T/derivatives/tracking_csddet_trk/sub-{}/dwi/sub-{}_dwi_var-csddet-run-{}_tract.trk",
...
mapping["hcp7t"] = {
    ...
    "output": root + "O3D_HCP7T/derivatives/tracking_csddet_trk/sub-{}/dwi/sub-{}_dwi_var-csddet-run-{}_tract.trk",
