function [fg, keep] = clean_tract(fg,maxDist,maxLenStd,numNodes,centralTendency,count,maxIter)
%
% Source: https://github.com/francopestilli/mba/blob/master/compute/mbaComputeFibersOutliers.m
%
% Remove fibers from a fiber group that differ substantially from the
% mean fiber in the group.
%
%    [fg keep]=clean_tract(fibers,maxDist,maxLenStd,numNodes, ...
